...
// Constructores del formulario 
 ...
 private void isExtra() {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(100, 90, 470, 40);
        jPanel1.add(jSeparator1);
        jSeparator1.setBounds(100, 80, 470, 2);
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(20, 140, 340, 40);
        ...
        btnImprimir.setBounds(370, 150, 37, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 0, 640, 190);

        getAccessibleContext().setAccessibleName("Carg");

        setBounds(150, 0, 653, 223);
